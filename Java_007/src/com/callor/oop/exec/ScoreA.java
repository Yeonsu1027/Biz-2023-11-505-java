...
public class ScoreA {
	...
	public static void main(String[] args) {
		...
		// 인스턴스 화(化) 되었다.  // 객체=인스턴스
		ScoreService 철수성적 = new ScoreService();  // new~~ 생성자 method
		...
		System.out.println(철수성적.scoreKor + 철수성적.scoreEng + 철수성적.scoreMath); //일일이 더하는 방법
		
		System.out.println(철수성적.getScoreTotal()); //자동으로 점수의 합산을 보여줌
