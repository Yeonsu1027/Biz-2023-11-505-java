...
public class ScoreService {
	...
	/*
	 * intpustScore() method 를 매개변수 없이 호출하면
...
//			strStdNum = scores.get(scores.size()-1).stdNum;
	//	} else {
		...
		int intStdNum= Integer.valueOf(strStdNum.substring(2));  //앞에 23잘라내고 0000에서 1씩추가
		intStdNum++;
		
		strStdNum = String.format("23%04d", intStdNum);  //0001의 형태를바꿈 -> 230001
