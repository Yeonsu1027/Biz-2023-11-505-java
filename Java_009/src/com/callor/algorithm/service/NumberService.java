...
public class NumberService {
	...
	private Scanner scan = null; //class에 선언할땐 private가 좋다
	
	public NumberService() {
		
		scan = new Scanner(System.in);  //생성자의 초기화 코드를 넣어둔다 //try catch 없이 익셉션을 방지한다
	}
